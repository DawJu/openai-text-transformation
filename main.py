...
def generate_html_from_article(file_path):
    ...
    tranformation_prompt = (
        'Transform the following article into structured HTML suitable for a webpage. '
        'Use appropriate HTML tags, insert <img> tags for relevant image placeholders with src="image_placeholder.jpg" attribute and detailed prompts in the alt attribute, '
        'and add captions using appropriate tags. Ensure the output includes only the content between <body> and </body>, excluding the <body> and </body> markers themselves\n\n'
        f'Article:\n{article_content}'
    )
